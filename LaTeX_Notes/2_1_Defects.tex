...
\subsection{Modelling dynamically evolving defects}
...
Of course, the above description is not only restricted to the toric code case. For instance, we are able to efficiently describe topological quantum systems similar to the golden chain \cite{Feiguin2007} when allowing the presence of defects. We now review a very simple but still interesting example.
