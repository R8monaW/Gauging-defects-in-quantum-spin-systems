...
\subsection*{Step 5: Find action of the category on the vertex} After the vertex itself is defined, the left and right action of the category on it has to be computed, which corresponds to finding the maps
	\begin{align*}
