...
which is a vector in the morphism space
	...
	\end{figure}
\noindent
We now have to find a basis for every one of those morphism spaces, i.e.\ for every choise of $x+y$ and $y+z$.