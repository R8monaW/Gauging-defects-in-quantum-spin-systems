...
\subsection*{Step 1: Compute isomorphism classes of objects and pick a representative} According to the figure above, $(*,a,b)\cong(+,a+x+y,b+y+z)$ for all possible labels $x,y,z$, so we pick $(*,0,0)$ as a representative.
