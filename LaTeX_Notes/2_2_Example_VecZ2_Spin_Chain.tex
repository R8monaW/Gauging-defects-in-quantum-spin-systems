...
We will study a concrete example in detail in Section~\ref{Ising}, namely a particle chain in the sense of the golden chain presented in \cite{Feiguin2007}, which is based on a fusion category with $\Vec(\Z/2\Z)$ fusion rules with pairwise interaction. Since the discussion of this example requires some background on fusion categories and bimodules as well as annular categories, we will present the mathematical preliminaries in the next section before explicitly constructing the defects afterwards.
